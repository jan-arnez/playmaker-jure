...
export function GoogleButton({ context = "login" }: GoogleButtonProps) {
  const t = useTranslations("AuthModule.googleButton");
  ...
  const buttonText =
    context === "signup" ? t("signupWithGoogle") : t("loginWithGoogle");
